...
//Change logotype
$('#top-left-logo-link').attr("href","https://www.tresdefebrero.gov.ar/");
$('#top-left-logo').attr("src","templates/3df-template/img/logo.png");
$('#top-left-logo').attr("alt","Logo 3 de Febrero");
$('#top-left-logo').attr("title","3 de Febrero");
$('#top-right-logo-link').attr("href","");
$('#top-right-logo').attr("src","");
$('#top-right-logo').attr("alt","");
$('#top-right-logo').attr("title","");
